module.exports = function() {
  return [
    ...
    },
    {
      no: 25,
      static: 'pg25ex8s1',
      staticAudioSrc: 'pg25-1',
      staticTrigger: {
        bottom: '41%',
        top: '14%'
      },
      static2: 'pg25ex8s2',
      static2AudioSrc: 'pg25-2',
      static2Trigger: {
        bottom: '4%',
        top: '60%'
      }
    ...
    },
    {
      no: 44,
      static: 'pg44ex6s1',
      staticAudioSrc: 'pg44-1',
      staticTrigger: {
        bottom: '31%',
        top: '14%'
      },
      static2: 'pg44ex6s2',
      static2AudioSrc: 'pg44-2',
      static2Trigger: {
        bottom: '4%',
        top: '69%'
      }
    ...
    },
    {
      ...
      ex2: {
        ...
        {
            identifier: 'six',
            position: 'top: 30%; left: 36.6%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '1'
          },
          {
            identifier: 'seven',
            position: 'top: 30%; left: 59.8%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '4'
          },
          {
            identifier: 'eight',
            position: 'top: 30%; left: 83.1%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '2'
          },
          {
            identifier: 'nine',
            position: 'top: 43.6%; left: 20.5%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '4'
          },
          {
            identifier: 'ten',
            position: 'top: 43.6%; left: 43.4%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '3'
          },
          {
            identifier: 'eleven',
            position: 'top: 43.6%; left: 60.3%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '1'
          },
          {
            identifier: 'twelve',
            position: 'top: 43.6%; left: 77.2%; width: 3.5%; height: 4.9%',
            model: '',
            solution: '2'
          },
          {
            identifier: 'thirteen',
            position: 'top: 38.6%; left: 12.2%; width: 18.5%; height: 3.9%',
            model: '',
            solution: null
          }
        ]
    ...
    },
    {
      no: 64,
      static: 'pg64ex10s1',
      staticAudioSrc: 'pg64-1',
      staticTrigger: {
        bottom: '65.5%',
        top: '11%'
      },
      static2: 'pg64ex10s2',
      static2AudioSrc: 'pg64-2',
      static2Trigger: {
        bottom: '51%',
        top: '34.5%'
      },
      static3: 'pg64ex10s3',
      static3AudioSrc: 'pg64-3',
      static3Trigger: {
        bottom: '33.5%',
        top: '49%'
      }
